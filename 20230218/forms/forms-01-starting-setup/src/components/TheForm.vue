<template>
  <form @submit.prevent="submitForm">
    ...
    <div class="form-control">
      ...
      <div>
        <input id="interest-tutorials" name="interest" type="checkbox" value="turorials" v-model="interest" />
  ...
  export default {
    ...
    data() {
      return {
        userName: '',
        userAge: null,
        referrer: 'wom', // for select drop down
        interest: [], // checkbox
        how: null, // radio
        confirm: false,
    ...
    methods: {
      submitForm() {
        ...
        console.log(this.userAge); // type is number
        console.log(this.$refs.ageInput.value); // type is string
        console.log(31); // type is number
        this.userAge = null;
